...
public final class WebDriverUtility {
	 ...
	 * @param javaUtility
	 */
	public void TakesScreenShot(String currentClass,JavaUtility javaUtility)
	{
		TakesScreenshot ts=(TakesScreenshot)driver;
		File src=ts.getScreenshotAs(OutputType.FILE);
		File trg=new File("./errorshots/"+currentClass+javaUtility.getCurrentDate("dd_MM_yyyy_HH_mm_sss")+".png");
		try 
		{
	 ...
	 * @param element
	 */
	public void TakesScreenShot(String currentClass,JavaUtility javaUtility,WebElement element)
	{
